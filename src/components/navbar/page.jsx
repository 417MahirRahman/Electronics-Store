          ...
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="hidden md:flex space-x-8">
              ...
              <Link
                href="/product"
                className={`font-medium transition-colors ${
                  isActive("/product") ? "text-blue-600 border-b-2 border-blue-600" : "text-gray-700 hover:text-blue-600"
                }`}
              >
                Products
              </Link>
              <Link
                href="/bestDeals"
                className={`font-medium transition-colors ${
                  isActive("/bestDeals") ? "text-blue-600 border-b-2 border-blue-600" : "text-gray-700 hover:text-blue-600"
                }`}
              >
                Best Deals
              </Link>
